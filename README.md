...
# Project Description
This project is about image classifcation of the high-speed train locomotives in South Korea, analyzing and predicting KTX (Korea Train eXpress) and SRT (Super Rapid Train) passenger ridership. Random image datasets were given into the neural network model and the combined passenger ridership datasets were acquired from KORAIL (한국철도공사) and SRT (수서고속철도주식회사). 
